...
public class ButtonRound extends JButton {
    ...
    public ButtonRound() {
        ...
        setColor(new Color(63, 63, 65));
        colorOver = new Color(63, 63, 65);
        colorClick = new Color(53, 53, 55);
        borderColor = new Color(63, 63, 65);
    ...
    private Color colorOver =new Color(63, 63, 65);
