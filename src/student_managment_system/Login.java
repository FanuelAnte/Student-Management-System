...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(426, 67, 443, 90));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 180, -1, 620));

        close.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/closeMac.png"))); // NOI18N
        ...
        jPanel1.add(close, new org.netbeans.lib.awtextra.AbsoluteConstraints(1240, 10, -1, 40));

        minimize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/minimizeMac.png"))); // NOI18N
        ...
        jPanel1.add(minimize, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 10, -1, 40));
    ...
    private void signinBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signinBtnActionPerformed
        if (emailTxt.getText().equals("") && passwordTxt.getText().equals("")) {
            ...
            rgr = RegistrarDao.login(email, password);
            if (rgr == null) {
